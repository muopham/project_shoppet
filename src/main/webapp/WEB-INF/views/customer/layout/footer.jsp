						...
						<div class="footer-widget">
							...
							<div class="widget-content">
								<p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
									Magni, dicta libero debitis delectus eum praesentium esse error
									eius odio, maxime labore iste earum ratione natus autem illum
									porro veniam enim.</p>
							</div>
					...
					<div class="col-12 col-lg-3 col-md-6">
						<div class="footer-widget">
							...
							<div class="widget-subscribe">
								<form action="${base }/contact">
									<input type="email" id="idEmailSub" name="emailSub" placeholder="mail@gmai.com">
									<button type="button" class="widget-btn"
										onclick="saveSubscribe( '${base}');">Gửi</button>
								</form>
							</div>
						</div>
					</div>
